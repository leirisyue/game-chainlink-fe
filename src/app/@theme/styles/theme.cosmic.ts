...
export const COSMIC_THEME = {
  ...
  variables: {
    ...
    traffic: {
      ...
      tooltipExtraCss: 'box-shadow: 0px 2px 46px 0 rgba(50, 50, 89); border-radius: 10px; padding: 4px 16px;white-space: pre-line;',
    ...
    electricity: {
      ...
      tooltipLineWidth: '0',
      tooltipBorderColor: baseThemeVariables.border2,
      tooltipExtraCss: 'box-shadow: 0px 2px 46px 0 rgba(0, 255, 170, 0.35); border-radius: 10px; padding: 8px 24px;white-space: pre-line;',
      tooltipTextColor: baseThemeVariables.fgText,
      tooltipFontWeight: 'normal',
    ...
    profitBarAnimationEchart: {
      ...
      tooltipExtraCss: 'border-radius: 10px; padding: 4px 16px;white-space: pre-line;',
    },
    ...
    orders: {
      ...
      tooltipLineWidth: '0',
      tooltipBorderColor: baseThemeVariables.border2,
      tooltipExtraCss: 'border-radius: 10px; padding: 8px 24px;white-space: pre-line;',
      tooltipTextColor: baseThemeVariables.fgText,
      tooltipFontWeight: 'normal',
      tooltipFontSize: '20',
